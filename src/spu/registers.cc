...
void PCSX::SPU::impl::writeRegister(uint32_t reg, uint16_t val) {
    ...
    switch (r) {
        ...
        case H_Reverb + 0:
            ...
            rvb.FB_SRC_A = val;
            reverb_regs.dAPF1 = (int16_t)(val * 4);
        ...
        case H_Reverb + 2:
            ...
            reverb_regs.dAPF2 = (int16_t)(val * 4);
            break;
        case H_Reverb + 4:
            rvb.IIR_ALPHA = (int16_t)val;
            reverb_regs.vIIR = (int16_t)(val);
            break;
        case H_Reverb + 6:
            rvb.ACC_COEF_A = (int16_t)val;
            reverb_regs.vCOMB1 = (int16_t)(val);
            break;
        case H_Reverb + 8:
            rvb.ACC_COEF_B = (int16_t)val;
            reverb_regs.vCOMB2 = (int16_t)(val);
            break;
        case H_Reverb + 10:
            rvb.ACC_COEF_C = (int16_t)val;
            reverb_regs.vCOMB3 = (int16_t)(val);
            break;
        case H_Reverb + 12:
            rvb.ACC_COEF_D = (int16_t)val;
            reverb_regs.vCOMB4 = (int16_t)(val);
            break;
        case H_Reverb + 14:
            rvb.IIR_COEF = (int16_t)val;
            reverb_regs.vWALL = (int16_t)(val);
            break;
        case H_Reverb + 16:
            rvb.FB_ALPHA = (int16_t)val;
            reverb_regs.vAPF1 = (int16_t)(val);
            break;
        case H_Reverb + 18:
            rvb.FB_X = (int16_t)val;
            reverb_regs.vAPF2 = (int16_t)(val);
            break;
        case H_Reverb + 20:
            rvb.IIR_DEST_A0 = (int16_t)val;
            reverb_regs.mLSAME = (uint16_t)(val * 4);
            break;
        case H_Reverb + 22:
            rvb.IIR_DEST_A1 = (int16_t)val;
            reverb_regs.mRSAME = (uint16_t)(val * 4);
            break;
        case H_Reverb + 24:
            rvb.ACC_SRC_A0 = (int16_t)val;
            reverb_regs.mLCOMB1 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 26:
            rvb.ACC_SRC_A1 = (int16_t)val;
            reverb_regs.mRCOMB1 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 28:
            rvb.ACC_SRC_B0 = (int16_t)val;
            reverb_regs.mLCOMB2 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 30:
            rvb.ACC_SRC_B1 = (int16_t)val;
            reverb_regs.mRCOMB2 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 32:
            rvb.IIR_SRC_A0 = (int16_t)val;
            reverb_regs.dLSAME = (uint16_t)(val * 4);
            break;
        case H_Reverb + 34:
            rvb.IIR_SRC_A1 = (int16_t)val;
            reverb_regs.dRSAME = (uint16_t)(val * 4);
            break;
        case H_Reverb + 36:
            rvb.IIR_DEST_B0 = (int16_t)val;
            reverb_regs.mLDIFF = (uint16_t)(val * 4);
            break;
        case H_Reverb + 38:
            rvb.IIR_DEST_B1 = (int16_t)val;
            reverb_regs.mRDIFF = (uint16_t)(val * 4);
            break;
        case H_Reverb + 40:
            rvb.ACC_SRC_C0 = (int16_t)val;
            reverb_regs.mLCOMB3 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 42:
            rvb.ACC_SRC_C1 = (int16_t)val;
            reverb_regs.mRCOMB3 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 44:
            rvb.ACC_SRC_D0 = (int16_t)val;
            reverb_regs.mLCOMB4 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 46:
            rvb.ACC_SRC_D1 = (int16_t)val;
            reverb_regs.mRCOMB4 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 48:
            rvb.IIR_SRC_B1 = (int16_t)val;
            reverb_regs.dLDIFF = (uint16_t)(val * 4);
            break;
        case H_Reverb + 50:
            rvb.IIR_SRC_B0 = (int16_t)val;
            reverb_regs.dRDIFF = (uint16_t)(val * 4);
            break;
        case H_Reverb + 52:
            rvb.MIX_DEST_A0 = (int16_t)val;
            reverb_regs.mLAPF1 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 54:
            rvb.MIX_DEST_A1 = (int16_t)val;
            reverb_regs.mRAPF1 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 56:
            rvb.MIX_DEST_B0 = (int16_t)val;
            reverb_regs.mLAPF2 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 58:
            rvb.MIX_DEST_B1 = (int16_t)val;
            reverb_regs.mRAPF2 = (uint16_t)(val * 4);
            break;
        case H_Reverb + 60:
            rvb.IN_COEF_L = (int16_t)val;
            reverb_regs.vLIN = (int16_t)(val);
            break;
        case H_Reverb + 62:
            rvb.IN_COEF_R = (int16_t)val;
            reverb_regs.vRIN = (int16_t)(val);
            break;
    }
